   ...
   <div class="card">
    <div class="card-body">
     ...
     <?php  
        ...
        $requete="DELETE FROM `blacklist` WHERE `extension`='".$_GET['id']."'";
        $exec_req = mysqli_query($db,$requete);

      
        $x=$_GET['id'];

        exec("perl single_command.pl blacklist del blocked ".$x)  ;
    ...
    <div id='main_content'>
       ...
       <div class="alert alert-success" role="alert">
          <h3 align="center">Suppression de l'extension bloquée avec succès</h3>
       </div>
       <dir align="center">
