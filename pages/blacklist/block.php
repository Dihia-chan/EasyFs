    ...
    <div id="main-wrapper">
     ...
     <?php  
        ...
        $db = mysqli_connect($db_host, $db_username, $db_password,$db_name)
         ...
         $requete= "INSERT INTO `blacklist`(`Date`, `extension`, `descp`, `actif`) VALUES               ('".strftime("%F %T")."','".$id."','".$descp."','".$etat."')";
         $exec_requete = mysqli_query($db,$requete);
         if ($etat == 'oui'){
            exec("perl single_command.pl blacklist add blocked ".$id)  ;
            exec("perl single_command.pl blacklist save blocked");
         }  
      ?> 
    <!-- Main content -->
   
        <div class="alert alert-success" role="alert">
          <h3 align="center">Extension bloquée</h3> 
       </div>
       <div align="center" >
         <button type="button" class="btn btn-success btn-rounded m-b-10 m-l-5">
        <a href="blacklist.php">Retour</a>
       </button>
       </div>
 </div>
            <!-- End Container fluid  -->
