    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a  href="../extension/creation.php" aria-expanded="false"><i class="fa fa-wpforms"></i><span class="hide-menu">Gestion des extensions</span></a>
                        </li>
      ...
      <?php  
        ...
        $mdp = htmlspecialchars($_POST['mdp']);
              ...
              $requete="INSERT INTO `users`(`date`, `username`, `mdp`, `nom`, `prenom`, `addrMail`, `descp`, `bool`,`etat`)VALUES ('".strftime("%F %T")."','".$username."','".$mdp."','".$nom."','".$prenom."','".$addr."','".$descp."','0' ,'".$_POST['etat']."')";
