                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="../profile/user.php"><i class="ti-user"></i> Profile</a></li>
   ...
   <div class="card">
    <div class="card-body">
      <?php 
        ...
        $req = "SELECT * FROM `users` ORDER BY `date` DESC";
        $exec_req = mysqli_query($db,$req);
        $nbr = mysqli_num_rows($exec_req);
         ?> 
   <div align="Left">
    <h1><i>Gestion des comptes</i></h1>
     <form id="custom-search-form" action="recherche.php" method="post">
         <!--<div class="input-append span12">
            <input type="text" class="search-query" name="data" placeholder="Search">
               <button type="submit" class="btn"><i class="icon-search"></i></button>
          </div>-->
      </form> 
    </div>
    <table id="example2" class="table table-bordered table-hover" >
    <caption>Liste des comptes utilisateurs</caption>
    <thead>
      <tr align="right" valign="center">
      	<th colspan="8" ><a href="creation.php"><img src="../../images/p.jpg" width="3%" alt="plus"/></a></th>
      </tr>
      <tr align="center">
        <th >Date d'ajout</th>
        <th >Nom</th>
        ...
        <th >Description</th>
        <th>Actif</th>
        <th scope="col" width="5%"><img src="../../images/pencil-icon.jpg" width="100%" alt="edit" /></th>
        <th width="6%"><img src="../../images/s.jpg" width="70%" alt="supp"></span></th>
      </tr>
    </thead>
   <tfoot>
      <tr>
        <td colspan="8">Nombre de lignes :<?php echo $nbr; ?></td>
      </tr>
    </tfoot>
    <tbody align="center">
      <!--<tr>-->
        <?php  
          ...
          echo   
          ' <tr><td >'.$rep['date'].'</td><td >'. $rep['nom'].'</td><td >'.$rep['prenom'].'</td><td >'.$rep['addrMail'].'</td><td >'.$rep['descp'].'</td><td>'.$rep['etat'].'</td><td><a href="modif.php?id='.$rep['username'].'"><img src="../../images/pencil-icon.jpg" width="100%" alt="edit" /></a></td><td><a href="supp.php?id='.$rep['username'].'" ><img src="../../images/s.png" width="70%" alt="supp" /></a></span></td></tr>' ;
