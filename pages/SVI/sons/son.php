...
<div class="preloader">
    ...
    <div id="main-wrapper">
		...
		<form enctype="multipart/form-data" method='post' name='frm' action='importer.php'>
            <table width='100%' border='0' cellpadding='0' cellspacing='0'>
                ...
                <tr>
                    ...
                    <td width='70%'>
                        <select class='formfld'  name="son">
                            <option value="invalid">son si invalide</option>
                            <option value="exits">exit sound</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td class='vncellreq' align='left'>
                         Nom
                    </td>
