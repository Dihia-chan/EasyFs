...
<div class="container-fluid">
 <div class="row">
  <div class="col-12">
    ...
    <div class="card-body">
       <?php 
        ...
        $nbr = mysqli_num_rows($exec_req);
         ?> 
   <div align="Left">
    <h1><i>Gestion du SVI</i></h1>
    
    </div>
    <table id="example2" class="table table-bordered table-hover" >
    <caption>Liste des SVIs</caption>
    <thead>
      <tr align="right">
        <th colspan="5"><a href="svi.php"><img src="../../images/p.jpg" width="3%" alt="plus" /></a></th>
      </tr>
      <tr align="center">
        <th >Nom</th>
        <th >Extension</th>
   ...
   <tfoot>
      <tr>
        <td colspan="5">Nombre de lignes :<?php echo $nbr; ?></td>
      </tr>
    </tfoot>
    <tbody align="center">
      <!--<tr>-->
        <?php  
          ...
          echo   
          ' <tr><td >'.$rep['nom'].'</td><td >'. $rep['num'].'</td><td >'.$rep['descpm'].'</td><td><a href="modif.php?id='.$rep['nom'].'"><img src="../../images/pencil-icon.jpg" width="100%" alt="edit" /></a></td><td><a href="supp.php?id='.$rep['nom'].'" ><img src="../../images/s.png" width="70%" alt="supp" /></a></td></tr>' ;
