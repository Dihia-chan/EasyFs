   ...
   <div class="card">
    <div class="card-body">
     ...
     <?php  
        ...
        $requete="DELETE FROM `svi` WHERE `nom`='".$_GET['id']."'";
        ...
        //echo $x ;
        unlink("/usr/local/freeswitch/conf/ivr_menus/".$x.".xml");
        unlink("/usr/local/freeswitch/conf/dialplan/default/".$x.".xml");
    ...
    <div id='main_content'>
       ...
       <div class="alert alert-success" role="alert">
          <h3 align="center">Suppression du SVI avec succès</h3>
       </div>
       <dir align="center">
