...
<div class="preloader">
    ...
    <div id="main-wrapper">
		...
		<form enctype="multipart/form-data" method='post' name='frm' action='uploadMsgc.php'>
            <table width='100%' border='0' cellpadding='0' cellspacing='0'>
                <tr>
                    <td>
                        <h2><i>Message court</i></h2>
                         <br>
                    </td>
                ...
                <tr>
                    <td colspan="2" align='left' valign='top'>
                        <font color="99abb4">Le message court est joué lors du retour dans le menu, donc à la suite du message long.</font><br> <br>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width='70%' class='vtable' align='left'>
                        ...
                        <br />
                        Entrez le nom de votre message court
                    </td>
                </tr>
				<tr>
                    ...
                    <td width='70%' class='vtable' align='left'>
                        ...
                        <br/>
                        Entrez votre message court (.wav)
      				</td>
                </tr>
                <tr>
