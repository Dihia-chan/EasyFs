...
<?php 
   ...
   $r = "INSERT INTO `svi`(`nom`, `num`, `macrol`, `macroc`, `digit1`, `digit2`, `digit3`, `digit4`, `digit5`, `destination1`, `destination2`, `destination3`, `destination4`, `destination5`, `descp1`, `descp2`, `descp3`, `descp4`, `descp5`, `timeout`, `nbrC`, `timeoutd`, `fail`, `maxtimeout`, `descpm`) VALUES ('".$id."','".$extension."','".$macl."','".$macc."','".$_POST['digit1']."','".$_POST['digit2']."','".$_POST['digit3']."','".$_POST['digit4']."','".$_POST['digit5']."','".$_POST['destination1']."','".$_POST['destination2']."','".$_POST['destination3']."','".$_POST['destination4']."','".$_POST['destination5']."','".$_POST['descp1']."','".$_POST['descp2']."','".$_POST['descp3']."','".$_POST['descp4']."','".$_POST['descp5']."','".$_POST['timeout']."','".$_POST['nbrC']."','".$_POST['
timeoutd']."','".$_POST['fail']."','".$_POST['maxtimeout']."','".$_POST['descpm']."')";
...
<!-- Main content -->
    <div id='main_content'>
       ...
       <div class="alert alert-success" role="alert">
          <h3 align="center">SVI crée avec succès</h3>
       </div>
       <dir align="center">
