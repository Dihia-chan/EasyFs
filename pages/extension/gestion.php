   ...
   <div class="card">
    <div class="card-body">
       <?php 
        ...
        $req = "SELECT * FROM `extension` ORDER BY `date` DESC";
        $exec_req = mysqli_query($db,$req);
        $nbr = mysqli_num_rows($exec_req);
         ?> 
   <div align="Left">
    <h1><i>Gestion des extensions</i></h1>
    ...
    <caption>Liste des extensions</caption>
    <thead>
      <tr align="right">
        <th colspan="7"><a href="creation.php"><img src="../../images/p.jpg" width="3%" alt="plus" /></a></th>
      </tr>
      <tr align="center">
        <th >Date d'ajout</th>
        <th >Extension</th>
    ...
    <tbody align="center">
      <!--<tr>-->
        <?php  
          ...
          echo   
          ' <tr><td >'.$rep['date'].'</td><td >'. $rep['id'].'</td><td >'.$rep['idnom'].'</td><td >'.$rep['idnum'].'</td><td >'.$rep['descp'].'</td><td><a href="modif.php?id='.$rep['id'].'"><img src="../../images/pencil-icon.jpg" width="100%" alt="edit" /></a></td><td><a href="supp.php?id='.$rep['id'].'" ><img src="../../images/s.png" width="70%" alt="supp" /></a></td></tr>' ;
