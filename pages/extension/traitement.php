...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
      ...
      $requete="INSERT INTO `extension`(`date`, `id`, `etat`, `descp`, `mdp`, `vmdp`, `addr`, `idnom`, `idnum`) VALUES('".strftime("%F %T")."','".$id."','".$etat."','".$descp."','".$mdp."','".$vmdp."','lll','".$nom."','".$num."')";
         $exec_requete = mysqli_query($db,$requete);

         if ($_POST['users'])
          foreach ($_POST['users'] as $value) {
            $req="INSERT INTO `extuser`(`username`, `extension`) VALUES ('".$value."','".$id."')" ;
...
<div class="alert alert-success" role="alert">
          <h3 align="center">Extension crée</h3> 
       </div>
       <div align="center" >
