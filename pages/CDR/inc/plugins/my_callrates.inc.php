...
function my_callrates() {
	...
	/**************************** Config ****************************************************/
	$my_call_rates = array(
						"Urbain" 		=> "(dst LIKE '2%' OR dst LIKE '7%') and (LENGTH(dst)=7)",
						"T&ecute;l&eacute;phones portables"			=> "(dst LIKE '89%') and (LENGTH(dst)=11)",
						"Champ" 			=> "(dst LIKE '8351%') and (LENGTH(dst)=11)",
						"Les capitaux"			=> "(dst LIKE '8495%' OR dst LIKE '8499%' OR dst LIKE '8812%') and (LENGTH(dst)=11)",
						"F&ecute;d&ecute;ration" 			=> "(dst LIKE '8%') and (dst NOT LIKE '89%' and dst NOT LIKE '79%' and dst NOT LIKE '8351%' and dst NOT LIKE '8495%' and dst NOT LIKE '8499%' and dst NOT LIKE '8812%' and dst NOT LIKE '8800%') and (LENGTH(dst)=11)",
	);
	...
	echo '<p class="center title">Historique des appels - D&ecute;penses de fonds</p><table class="cdr">
		<tr>
